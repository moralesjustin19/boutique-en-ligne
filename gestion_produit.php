            ...
            <tbody>
                <?php foreach ($produits as $produit): ?>
                    <tr>
                        ...
                        <td>
                            <a href="modifier_produit.php?id=<?php echo $produit['id_produit']; ?>" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="supprimer_produit.php?id=<?php echo $produit['id_produit']; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
